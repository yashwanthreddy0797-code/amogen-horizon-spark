...
const AboutCareers = () => {
  return (
    <ScrollReveal>
      <section className="relative overflow-hidden min-h-[260px] md:min-h-[320px] md:max-h-[320px] flex items-stretch rounded-2xl mx-4 md:mx-8 mb-12 border border-border">
