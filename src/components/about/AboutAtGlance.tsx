    ...
    <section className="bg-card relative overflow-hidden" style={{ paddingTop: SPACING.sectionPy.desktop, paddingBottom: SPACING.sectionPy.desktop }}>
      <div className="mx-auto relative z-10" style={{ maxWidth: SPACING.maxWidth, paddingLeft: SPACING.sectionPx, paddingRight: SPACING.sectionPx }}>
        <ScrollReveal>
          ...
          <h2 style={TYPE.h2} className="text-primary text-6xl">Amogen at a glance</h2>
          <p style={{ ...TYPE.body, color: "hsl(var(--muted-foreground))", marginTop: SPACING.headingToSub }} className="max-w-3xl text-lg">
        ...
        <div className="grid md:grid-cols-3 mt-16 max-w-4xl mx-auto" style={{ gap: "32px" }}>
          {stats.map((stat, i) =>
